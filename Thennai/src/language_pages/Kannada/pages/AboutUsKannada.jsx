      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            >
              <strong>ತೇಂಗಾಯಿ</strong>ಯಲ್ಲಿ, ನಾವು ತೇಂಗಾಯಿ ಕೃಷಿಕರಿಗೆ ಮಾಹಿತಿಗಳು, ಸಾಧನಗಳು ಮತ್ತು ಸಮುದಾಯ ಸಂಪರ್ಕಗಳನ್ನು ಒದಗಿಸಲು ಬದ್ಧರಾಗಿದ್ದೇವೆ. ನಮ್ಮ ಗುರಿ ಕೃಷಿಯನ್ನು ಸರಳ, ಲಾಭಕಾರಿ ಮತ್ತು ಸತತಗೊಳಿಸುವುದಾಗಿದೆ.
            </motion.p>
          </div>
          <motion.div
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-700">
              <strong>ತೇಂಗಾಯಿ</strong>ಯ ಮೂಲಕ ಕೃಷಿಯನ್ನು ಅಭಿವೃದ್ಧಿಪಡಿಸಲು, ಲಾಭಕಾರಿಯನ್ನಾಗಿಸಲು ಮತ್ತು
              ಸತತಗೊಳಿಸಲು ತಂತ್ರಜ್ಞಾನ ಪರಿಹಾರಗಳನ್ನು ಒದಗಿಸುವುದು ನಮ್ಮ ಗುರಿಯಾಗಿದೆ.
            </p>
          </motion.div>
          <motion.div
            className="bg-white rounded-lg shadow-lg p-8"
